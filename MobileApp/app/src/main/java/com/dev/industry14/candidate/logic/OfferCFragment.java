 ...
 */
public class OfferCFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_offer_c , container, false);
        rootView.setTag(TAG);

        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.recOffer);
        ...
        mAdapter = new OfferAdapter(getContext(),LoginActivity.cOfferReq, LoginActivity.positionRDS);
