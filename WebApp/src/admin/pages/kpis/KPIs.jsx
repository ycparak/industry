      ...
      <Row>
        <Col sm="12" md="9" lg="7" className="card-activate-col--right">
          <Card className="dash-card dash-card--link dash-card--normal dash-card--primary">
            <span className="dash-card-link--header-text margin-bottom--8">Predicted monthly revenue</span>
            <div className="dash-chart padding-top--16">
              <Line
                ...
                data={{
                  ...
                  datasets: [{
                    data: [0, 0, 0, 0, 320000, 100000, 130000, 160000, 726321, 0, 0, 0],
        ...
        <Col sm="12" md="3" lg="5" className="card-activate-col--left">
          <Card className="dash-card dash-card--link dash-card--normal dash-card--warning">
            <span className="dash-card-link--header-text margin-bottom--8">User stage breakdown</span>
            <div className="dash-chart padding-top--16">
              <Doughnut
                height = {110}
                data={{
        ...
        <Col sm="12" md="3" lg="5" className="card-activate-col--left">
          <Card className="dash-card dash-card--link dash-card--normal">
            <span className="dash-card-link--header-text dash-comp-card-text margin-bottom--8">Landing page conversion rate</span>
            <div className="dash-chart padding-top--16">
              <Pie
                height = {110}
                data={{
