      ...
      <React.Fragment>
        <Navbar className="dash-navbar" expand="xs">
          <Nav className="mr-auto" navbar>
            {/* name */}
            <NavLink to="/candidate" className="dash-logo">
        ...
        <Navbar className="dash-navbar dash-navbar--small-screen" expand="xs">
          <Nav className="mr-auto" navbar>
            ...
            {!activated &&  
            <NavItem className="dash-nav-item">
              <NavLink to='/candidate/activate' className="dash-nav-link dash-comp-nav-link" activeClassName="dash-nav-link-active dash-comp-nav-link-active" tag={RRNavLink} exact>
                Activate account
